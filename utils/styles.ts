...
export const sectionStyles = "flex flex-col p-2";

export const selectStyles =
  "rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-3 text-white outline-none focus:border-blue-500";

export const formContainerStyles =
  "w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-950 p-6";
